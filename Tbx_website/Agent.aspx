...
<!-- Fonts -->
    ...
    <div class="customer-portal-heading">Agent Portal</div>
    <div class="welcome-message"> Welcome "Agent-name" </div>
    ...
    <div class="customer-portal">     
			...
			<ul class="inputs black-input large">
                ...
                <li><span class="icon-download  mid-margin-right"></span><a class="Available-products" href="Available_Projects_list_for_Agents.aspx">Available Projects</a></li>      
